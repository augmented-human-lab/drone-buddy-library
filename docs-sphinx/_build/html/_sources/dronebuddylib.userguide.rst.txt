...
.. note::
    Note: This C++ version is required to install CMake which is required to install the face recognition model. CMake is required to install dlib which is used by the face-recognition algorithm. Not required to follow this step if you are not using face recognition.
#.  pip install setuptools-rust
.. note::
    Note: Rust is required for SNIPS-NLU, the offline intent recognition which is explained further down in the documentation. Not required to follow this step if you are not using SNIPS-NLU.
