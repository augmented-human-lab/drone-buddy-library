...
Run the following command to install the basic functionalities of the library. However, if you want to use the intelligent functionalities such as object recognition, you need to install the respective submodules.
...
To install the library, you need to install the dlib library. The more detailed installation instructions can be found [here](https://github.com/ageitgey/face_recognition/issues/175#issue-257710508). To summarize, the installation instructions are here: 
