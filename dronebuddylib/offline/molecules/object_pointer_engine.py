from dronebuddylib.offline.atoms.gesture_recognition import is_pointing
...
from .hand_follower_engine import HandFollower


def get_pointed_obj(follower: HandFollower, yolo_engine: YoloEngine):
    ...
    Args:
        ...
        yolo_engine (YoloEngine): an initialized YoloEngine
    ...
    while follower.running:
        ...
        if is_pointing(result):
            obj_boxes = get_boxes_yolo(yolo_engine, frame)
